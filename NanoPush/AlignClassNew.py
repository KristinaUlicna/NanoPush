#TODO: THIS CLASS IS USING NEW NANOPOLISH MODEL DERIVED FROM MY DATA!!!
...
class Alignment:
    ...
    def ExtractCpGsignal(self):
        ...
        from NewOldModelFunction import New_Nanopolish_dictionary
        model_dict = New_Nanopolish_dictionary()
